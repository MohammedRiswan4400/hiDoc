...
//
//     final hiDoc = hiDocFromJson(jsonString);

import 'dart:convert';

HiDoc hiDocFromJson(String str) => HiDoc.fromJson(json.decode(str));

String hiDocToJson(HiDoc data) => json.encode(data.toJson());
